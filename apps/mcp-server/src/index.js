...
class SkyScoutMCPServer {
                ...
                tools: [
                    {
                        ...
                        description: 'Analyze current project structure and component relationships',
                        inputSchema: {
                            type: 'object',
                            properties: {
                                focus_area: {
                                    type: 'string',
                                    description: 'Area to focus analysis on (components, types, services, etc.)',
                                    enum: [
                                        'components',
                                        'types',
                                        'services',
            ...
            try {
                switch (name) {
                    case 'analyze_project_structure':
                        return yield this.analyzeProjectStructure((args === null || args === void 0 ? void 0 : args.focus_area) || 'components');
                    case 'run_performance_analysis':
                        return yield this.runPerformanceAnalysis((args === null || args === void 0 ? void 0 : args.type) || 'all');
                    case 'generate_component':
                        return yield this.generateComponent(args === null || args === void 0 ? void 0 : args.name, args === null || args === void 0 ? void 0 : args.type, args === null || args === void 0 ? void 0 : args.props);
                    case 'update_trip_management':
                        return yield this.updateTripManagement(args === null || args === void 0 ? void 0 : args.feature, args === null || args === void 0 ? void 0 : args.action, args === null || args === void 0 ? void 0 : args.details);
                    case 'run_tests':
                        return yield this.runTests((args === null || args === void 0 ? void 0 : args.scope) || 'unit', args === null || args === void 0 ? void 0 : args.component);
                    default:
                ...
                case 'skyscout://components':
                    return {
                        contents: [
                            {
                                type: 'text',
                                text: JSON.stringify(this.getComponentLibraryStructure(), null, 2),
                            },
                        ],
                    };
    ...
    analyzeProjectStructure(focusArea) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const focusAreaData = analysis[focusArea] || analysis;
            return {
                content: [
                    {
                        type: 'text',
...
4. Update documentation`,
    ...
    updateTripManagement(feature, action, details) {
        return __awaiter(this, void 0, void 0, function* () {
            return {
                content: [
                    {
...
4. Check Jest configuration`,
    ...
    getComponentStructure() {
        try {
            const uiLibPath = join(this.projectRoot, 'libs', 'ui', 'src', 'components');
            const webComponentsPath = join(this.projectRoot, 'apps', 'web', 'app', 'components');
            const structure = {
...
- Co-located tests and stories`;
    ...
    getComponentTemplate(name, type, props) {
        return `/**
 * ${name} Component
