...
export const flightRouter = router({
    search: baseProcedure
        ...
        var _b;
        try {
            const results = yield flightService.search(input, (_b = ctx.user) === null || _b === void 0 ? void 0 : _b.id);
            return results;
        }
        catch (error) {
            throw new TRPCError({
    ...
    autocomplete: baseProcedure
        ...
        return yield searchService.autocomplete(input);
    })),
    airports: baseProcedure
        ...
        .query((_a) => __awaiter(void 0, [_a], void 0, function* ({ input }) {
        return yield searchService.getAirports(input);
    })),
    priceHistory: baseProcedure
        ...
        .query((_a) => __awaiter(void 0, [_a], void 0, function* ({ input }) {
        return yield flightService.getPriceHistory(input);
    })),
    priceAlerts: protectedProcedure
        ...
        return yield flightService.createPriceAlert(Object.assign(Object.assign({}, input), { userId: ctx.user.id }));
    })),
    getUserAlerts: protectedProcedure.query((_a) => __awaiter(void 0, [_a], void 0, function* ({ ctx }) {
        return yield flightService.getUserPriceAlerts(ctx.user.id);
    })),
    deleteAlert: protectedProcedure
        ...
        .mutation((_a) => __awaiter(void 0, [_a], void 0, function* ({ input, ctx }) {
        return yield flightService.deletePriceAlert(input.alertId, ctx.user.id);
    })),
});
